...
## Features
- **Antigravity**: native image generation support (image models tagged kind:image, displayed in media-providers UI)
...
## Docs
- README: add Indonesian ITXBridge tutorial video (#1709)
