...
console.log("📦 Building ITXBridge CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/itxbridge/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.itxbridge/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.itxbridge/runtime)");
}
console.log("");
