...
const APP_NAME = "itxbridge";
const APP_LABEL = "com.itxbridge.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when itxbridge is currently
 ...
 * SIGTERM to the running process. When the running itxbridge cli.js was itself
...
<dict>
    ...
    <string>/tmp/itxbridge.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/itxbridge.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `itxbridge.cmd` lookup that depended on the npm prefix path.
