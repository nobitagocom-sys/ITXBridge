...
Deploy ITXBridge on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.itxbridge` | Database and data storage path |
...
Create `/etc/nginx/sites-available/itxbridge`:
