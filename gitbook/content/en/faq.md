...
Common questions about ITXBridge.

---

## What is ITXBridge?

**ITXBridge is an AI model router that maximizes your subscription value and minimizes costs.**
...
**ITXBridge uses a 3-tier pricing strategy:**
...
**Yes, ITXBridge itself is 100% free and open source.**
...
**Yes! This is ITXBridge's core feature.**
...
**ITXBridge tracks quota in real-time for all providers:**
...
## Can I self-host ITXBridge?

**Yes! ITXBridge supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.itxbridge`)
...
**Yes, ITXBridge prioritizes security and privacy:**

**Local storage:**

- All data stored locally in `~/.itxbridge` (or custom `DATA_DIR`)
- No data sent to ITXBridge servers
...
- Check [CHANGELOG.md](https://github.com/decolua/itxbridge/blob/main/CHANGELOG.md)
- Backup `~/.itxbridge` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/itxbridge/blob/main/CONTRIBUTING.md) for details.
