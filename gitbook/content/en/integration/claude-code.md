...
Integrate ITXBridge with Claude Code CLI to route your Anthropic API requests through ITXBridge's intelligent routing system.
...
Claude Code supports the following model aliases that map to ITXBridge models:
