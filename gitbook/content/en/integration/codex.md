...
Integrate ITXBridge with OpenAI Codex CLI to route your OpenAI API requests through ITXBridge's intelligent routing system.
...
ITXBridge provides the following Codex models:
...
1. Verify your API key is correct in ITXBridge dashboard
...
1. Verify the model name matches your ITXBridge configuration
2. Check that the OpenAI provider connection is active in ITXBridge dashboard
...
Make sure you have configured your API key in the ITXBridge cloud dashboard.
