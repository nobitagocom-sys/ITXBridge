...
Integrate ITXBridge with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- ITXBridge API key from [dashboard](https://itxbridge.com/dashboard)
- ITXBridge running (local or cloud)
...
### 2. Add ITXBridge Model Configuration
...
3. Choose your preferred ITXBridge model
...
- Check ITXBridge is running: `curl http://localhost:20127/health`
...
- Select correct ITXBridge model
...
- Check network latency to ITXBridge
