...
ITXBridge is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

ITXBridge provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to ITXBridge using these settings:
...
Model: any ITXBridge model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to ITXBridge
...
- Check network connection to ITXBridge
