...
Integrate ITXBridge with Roo AI Assistant to access multiple AI models through a unified interface.
...
Choose from available ITXBridge models:
...
- Verify ITXBridge is running: `curl http://localhost:20127/health`
...
- Verify model is enabled in your ITXBridge plan
...
- Monitor ITXBridge logs for issues
