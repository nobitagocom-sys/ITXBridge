...
Common issues and solutions when using ITXBridge.
...
1. **Auto-refresh (default):**
   ITXBridge automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if ITXBridge is running:**
