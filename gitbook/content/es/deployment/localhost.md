...
Ejecuta ITXBridge en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala ITXBridge globalmente vía npm:
...
Inicia ITXBridge con un solo comando:
...
Presiona `Ctrl+C` en la terminal donde ITXBridge se está ejecutando.

```bash
# En la terminal ejecutando itxbridge
^C  # Presiona Ctrl+C
```
