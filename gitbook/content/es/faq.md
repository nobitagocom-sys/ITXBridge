...
Preguntas comunes sobre ITXBridge.

---

## ¿Qué es ITXBridge?

**ITXBridge es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**ITXBridge usa una estrategia de precios de 3 niveles:**
...
**Sí, ITXBridge en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de ITXBridge.**
...
**ITXBridge rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿ITXBridge funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de ITXBridge:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://itxbridge.com/v1
...
## ¿Puedo auto-hospedar ITXBridge?

**¡Sí! ITXBridge soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.itxbridge`)
...
**Sí, ITXBridge prioriza la seguridad y privacidad:**

**Almacenamiento local:**

- Todos los datos se almacenan localmente en `~/.itxbridge` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de ITXBridge
...
- Revisa [CHANGELOG.md](https://github.com/decolua/itxbridge/blob/main/CHANGELOG.md)
- Respalda `~/.itxbridge` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/itxbridge/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/itxbridge/discussions)
...
3. **Enviar código:**
   ...
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/itxbridge.git
   cd itxbridge
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/itxbridge/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [itxbridge.com/docs](https://itxbridge.com/docs)
