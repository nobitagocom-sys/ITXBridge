...
Guía detallada de instalación de ITXBridge con consejos de solución de problemas.
...
Instala ITXBridge globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `itxbridge`
- ✅ Auto-actualizaciones con `npm update -g itxbridge`
...
3. Se crea el directorio de datos en `~/.itxbridge`
...
**Ubicación por defecto:** `~/.itxbridge`
...
**Problema:** ITXBridge usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con itxbridge
```
...
- **Sitio web**: [itxbridge.com](https://itxbridge.com)
