...
Integra ITXBridge con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de ITXBridge.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- ITXBridge ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de ITXBridge:

**Para ITXBridge local:**

```
http://localhost:20127/v1
```

**Para ITXBridge en la nube:**
...
1. En el campo **Base URL**, ingresa tu endpoint de ITXBridge
...
3. La key debe comenzar con `sk-itxbridge-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de ITXBridge
...
4. Cline usará ITXBridge para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando ITXBridge
...
3. Obtén explicaciones potenciadas por IA a través de ITXBridge

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará ITXBridge para entender el contexto y hacer cambios
...
1. Verifica que ITXBridge esté corriendo: `curl http://localhost:20127/health`
...
2. Verifica que tu instancia de ITXBridge esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de ITXBridge para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de ITXBridge en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://itxbridge.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de ITXBridge
...
## Integración con características de ITXBridge

### Enrutamiento de modelos

ITXBridge enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, ITXBridge automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de ITXBridge:
