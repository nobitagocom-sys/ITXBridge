...
Integra ITXBridge con Roo AI Assistant para acceder a múltiples modelos de IA a través de una interfaz unificada.
...
Elige entre los modelos disponibles de ITXBridge:
...
```
Hello! Can you confirm you're connected through ITXBridge?
```
...
- Verifica que el modelo esté habilitado en tu plan de ITXBridge
...
- Monitorea los logs de ITXBridge por problemas
