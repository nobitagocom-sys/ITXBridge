...
Problemas comunes y soluciones al usar ITXBridge.
...
1. **Refresh automático (por defecto):**
   ITXBridge refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
- ITXBridge no está ejecutándose
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://itxbridge.com/v1
   ```
...
1. **Verifica si ITXBridge está ejecutándose:**

   ```bash
   # Verifica el proceso
   ps aux | grep itxbridge
...
- **GitHub Issues:** [github.com/decolua/itxbridge/issues](https://github.com/decolua/itxbridge/issues)
