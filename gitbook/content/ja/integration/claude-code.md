...
ITXBridgeをClaude Code CLIと統合し、AnthropicのAPIリクエストをITXBridgeのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはITXBridgeモデルにマッピングされる以下のモデルエイリアスをサポート:
