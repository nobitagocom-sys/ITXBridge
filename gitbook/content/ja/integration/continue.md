...
ITXBridgeをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://itxbridge.com/dashboard)からのITXBridge APIキー
- ITXBridgeが動作中 (ローカルまたはクラウド)
...
- ITXBridgeが動作中か確認: `curl http://localhost:20127/health`
