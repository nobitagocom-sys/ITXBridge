...
Triển khai ITXBridge trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.itxbridge` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/itxbridge`:
...
# If NOT using reverse proxy, allow ITXBridge ports
