...
Những câu hỏi phổ biến về ITXBridge.

---

## ITXBridge là gì?

**ITXBridge là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**ITXBridge dùng chiến lược pricing 3 tầng:**
...
## ITXBridge có miễn phí không?

**Có, ITXBridge hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của ITXBridge.**
...
**ITXBridge theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host ITXBridge không?

**Có! ITXBridge hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.itxbridge`)
...
**Có, ITXBridge ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**

- Mọi dữ liệu lưu cục bộ tại `~/.itxbridge` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server ITXBridge
...
## Làm thế nào để cập nhật ITXBridge?
...
- Xem [CHANGELOG.md](https://github.com/decolua/itxbridge/blob/main/CHANGELOG.md)
- Backup `~/.itxbridge` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/itxbridge/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [itxbridge.com/docs](https://itxbridge.com/docs)
