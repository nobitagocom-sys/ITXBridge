...
Hướng dẫn cài đặt chi tiết cho ITXBridge với mẹo troubleshooting.
...
Cài ITXBridge toàn cục để dùng ở bất kỳ đâu:
...
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `itxbridge`
- ✅ Auto-update với `npm update -g itxbridge`
...
3. Data directory được tạo tại `~/.itxbridge`
...
**Vấn đề:** ITXBridge dùng quá nhiều RAM
