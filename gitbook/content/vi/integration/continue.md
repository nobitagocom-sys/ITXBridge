...
Tích hợp ITXBridge với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- ITXBridge API key từ [dashboard](https://itxbridge.com/dashboard)
- ITXBridge đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model ITXBridge
...
3. Chọn model ITXBridge ưa thích
...
- Kiểm tra ITXBridge đang chạy: `curl http://localhost:20127/health`
...
- Kiểm tra độ trễ network đến ITXBridge
