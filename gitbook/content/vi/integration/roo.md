...
Tích hợp ITXBridge với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model ITXBridge có sẵn:
...
- Xác minh ITXBridge đang chạy: `curl http://localhost:20127/health`
...
- Xác minh model được bật trong ITXBridge plan
...
- Theo dõi logs ITXBridge để xem vấn đề
