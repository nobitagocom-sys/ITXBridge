...
Các vấn đề và giải pháp phổ biến khi dùng ITXBridge.
...
1. **Auto-refresh (mặc định):**
   ITXBridge tự refresh tokens. Đợi 30 giây rồi thử lại.
...
- ITXBridge không chạy
- Port 20127 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động ITXBridge:**
...
1. **Kiểm tra ITXBridge có chạy không:**
