...
**ITXBridge 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**是的,ITXBridge 优先考虑安全和隐私:**

**本地存储:**

- 所有数据存储在本地 `~/.itxbridge`(或自定义 `DATA_DIR`)
- 不会发送数据到 ITXBridge 服务器
...
- 查看 [CHANGELOG.md](https://github.com/decolua/itxbridge/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.itxbridge`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/decolua/itxbridge/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [itxbridge.com/docs](https://itxbridge.com/docs)
