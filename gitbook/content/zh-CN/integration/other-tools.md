...
ITXBridge 兼容任何支持 OpenAI API 格式的工具。本指南介绍各种工具和自定义应用的通用集成模式。

## 概览

ITXBridge 提供 OpenAI 兼容的 API endpoint,可与以下场景配合使用:
...
任何 OpenAI 兼容的工具都可以通过以下设置连接到 ITXBridge:
...
Model: 任意 ITXBridge 模型(cc/*, cx/*, glm/*, 等)
```
