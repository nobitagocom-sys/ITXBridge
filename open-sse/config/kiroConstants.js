 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what itxbridge needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a itxbridge
...
/**
 * Detect whether a model id refers to a itxbridge synthetic agentic variant.
...
/**
 * Detect whether a model id is a itxbridge synthetic thinking variant
...
/**
 * Resolve a itxbridge model id to the real upstream Kiro model id, plus flags
