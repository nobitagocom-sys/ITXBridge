 ...
 * into itxbridge-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are itxbridge fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic itxbridge variant set for a single upstream Kiro model.
 *
 ...
 * into itxbridge variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
