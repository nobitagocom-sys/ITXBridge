...
import { Icon,  Card, Button, Input, Modal, CardSkeleton, Toggle, ConfirmModal } from "@/shared/components";
            ...
            {tunnelEnabled && !tunnelLoading && tunnelReachable ? (
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-amber-300 dark:border-amber-800 bg-amber-500/5 text-sm text-amber-600 dark:text-amber-400">
                  <Icon name="progress_activity" size={18} className="animate-spin text-sm" />
              ...
              <>
                <div className="flex-1 flex items-center gap-2 px-3 py-1.5 rounded border border-red-300 dark:border-red-800 bg-red-500/5 text-sm text-red-600 dark:text-red-400">
                  <Icon name="error" size={18} className="text-sm" />
          ...
          <div className="bg-surface-2 border border-border-subtle rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Expose your local ITXBridge to the internet. No port forwarding, no static IP needed. Share endpoint URL with your team or use it in Cursor, Cline, and other AI tools from anywhere.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {TUNNEL_BENEFITS.map((benefit) => (
              <div key={benefit.title} className="flex flex-col items-center text-center p-3 rounded-lg bg-sidebar/50">
                <Icon name={benefit.icon} size={20} className="text-primary mb-1" />
