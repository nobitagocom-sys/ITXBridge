...
import { Icon,  Card, Button, Toggle, Input } from "@/shared/components";
...
export default function ProfilePage() {
  ...
  const handleExportDatabase = async (password) => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `itxbridge-backup-${stamp}.json`;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="size-10 sm:size-12 rounded-lg bg-green-500/10 text-green-500 flex items-center justify-center shrink-0">
                <Icon name="computer" size={18} className="text-xl sm:text-2xl" />
              </div>
              <div>
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.itxbridge/db/data.sqlite</p>
              </div>
            </div>
...
{/* Security — Hidden */}
        ...
        {/* <Card>
          ...
          >
            ...
            <Icon name={oidcExpanded ? "expand_less" : "expand_more"} size={18} className="text-text-muted shrink-0" />
          </button>
          {oidcExpanded && (
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="https://auth.example.com/application/o/itxbridge/"
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="itxbridge-dashboard"
