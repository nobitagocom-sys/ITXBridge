...
import { Icon,  Button, Modal } from "@/shared/components";
      ...
      <div className="flex flex-col gap-4">
        ...
        {testStatus === "ok" && (
          <div className="flex items-center gap-2 text-sm text-green-600">
            <Icon name="check_circle" size={18} className="text-base" />
            Model is reachable
          </div>
        )}
        {testStatus === "error" && (
          <div className="flex items-start gap-2 text-sm text-red-500">
            <Icon name="cancel" size={18} className="text-base shrink-0" />
