...
import { Icon,  Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, IFlowCookieModal, GitLabAuthModal, Toggle, Select, EditConnectionModal, NoAuthProxyCard, ConfirmModal } from "@/shared/components";
...
export default function ProviderDetailPage() {
  ...
  const providerInfo = providerNode
    ? {
        ...
        color: providerNode.type === "anthropic-compatible" ? "#5E6AD2" : "#10A37F",
  ...
  const renderModelsSection = () => {
    ...
    return (
      <div className="flex flex-wrap gap-3">
        ...
        >
          <Icon name="add" size={18} className="text-sm" />
          Add Model
        </button>
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:gap-8 sm:px-0">
      ...
      <div className="min-w-0">
        ...
        >
          <Icon name="arrow_back" size={18} className="text-lg" />
          Back to Providers
        </Link>
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {(providerInfo.notice?.apiKeyUrl || providerInfo.notice?.signupUrl || providerInfo.website) && (
                ...
                >
                  <Icon name="open_in_new" size={18} className="text-sm" />
      ...
      {providerInfo.deprecated && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-yellow-500/10 border border-yellow-500/30">
          <Icon name="warning" size={16} className="text-yellow-500 mt-0.5 shrink-0" />
      ...
      {providerInfo.notice?.text && !providerInfo.deprecated && (
        <div className="flex flex-col gap-2 rounded-lg border border-blue-500/30 bg-blue-500/10 px-3 py-2 sm:flex-row sm:items-center">
          <Icon name="info" size={16} className="text-blue-500 shrink-0" />
