...
// Build TOML config for ITXBridge (openai provider mode)
const buildITXBridgeConfig = (baseUrl, apiKey, model) => {
...
// Detect ITXBridge by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildITXBridgeConfig(baseUrl, apiKey || "sk_itxbridge", model);
