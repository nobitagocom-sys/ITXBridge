...
import { Icon,  Modal, Button, Input, OAuthModal } from "@/shared/components";
        ...
        {!mode && (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <Icon name="lock_open" size={18} className="text-2xl text-primary" />
                <div>
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-primary hover:bg-primary/5 transition-colors text-left"
              >
                <Icon name="key" size={18} className="text-2xl text-primary" />
                <div>
