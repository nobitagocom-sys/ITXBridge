...
import { Icon,  Modal, Button, Input } from "@/shared/components";
      ...
      <div className="flex flex-col gap-4">
        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            >
              <div className="flex items-start gap-3">
                <Icon name="business" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <Icon name="key" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <Icon name="account_circle" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <Icon name="file_upload" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
            ...
            >
              <div className="flex items-start gap-3">
                <Icon name="data_object" size={18} className="text-primary mt-0.5" />
                <div className="flex-1">
        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
              <div className="flex gap-2">
                <Icon name="info" size={18} className="text-amber-600 dark:text-amber-400" />
            ...
            {autoDetecting && (
              <div className="text-center py-6">
                <div className="size-16 mx-auto mb-4 rounded-full bg-primary/10 flex items-center justify-center">
                  <Icon name="progress_activity" size={30} className="text-primary animate-spin" />
                </div>
