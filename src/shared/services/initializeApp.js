...
import { cleanupProviderConnections, getSettings, updateSettings, getApiKeys, ensureDefaultApiKey } from "@/lib/localDb";
import {
...
async function autoStartMitm() {
  ...
  try {
    ...
    await startMitm(activeKey?.key || "sk_itxbridge", password);
